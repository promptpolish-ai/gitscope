...
<div class="container">
  ...
  <section style="text-align:center;background:linear-gradient(135deg,rgba(74,222,128,0.08),rgba(56,189,248,0.08));border:1px solid rgba(74,222,128,0.3);">
    ...
    <p style="color:var(--text2);margin-bottom:1rem;">Found this report useful? Support the project — every coffee helps! ☕</p>

    <!-- GitHub Sponsors (lowest friction) -->
    <div style="margin-bottom:0.8rem;">
      <a href="https://github.com/sponsors/promptpolish-ai" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;padding:0.7rem 1.5rem;background:linear-gradient(135deg,#6c5ce7,#a78bfa);color:white;text-decoration:none;border-radius:12px;font-weight:700;font-size:1rem;transition:transform 0.2s;margin-bottom:0.3rem;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='none'">
        ❤️ Sponsor via GitHub
      </a>
      <p style="color:var(--text2);font-size:0.75rem;">Recurring or one-time · Any amount helps</p>
    </div>

    <!-- BTC secondary -->
    <details style="margin-top:0.3rem;">
      <summary style="color:var(--text2);font-size:0.8rem;cursor:pointer;">💎 Also accept Bitcoin</summary>
      <div style="background:var(--surface2);padding:0.5rem 0.8rem;border-radius:8px;font-family:monospace;font-size:0.8rem;word-break:break-all;display:inline-block;color:var(--green);margin-top:0.5rem;">
        1DQXcKwN95AWqwmwbscG7fRbEYMdWU9GB3
      </div>
    </details>

    <p style="color:var(--text2);font-size:0.8rem;margin-top:0.8rem;">
      <a href="https://gitscore-chi.vercel.app" style="color:var(--accent);">🔍 Free repo health score →</a>
      <span style="color:var(--surface2);margin:0 0.5rem;">|</span>
